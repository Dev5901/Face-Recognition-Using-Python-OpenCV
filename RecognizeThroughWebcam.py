...
vs = cv2.VideoCapture(0)#input video, 0 means input is through webcam
...
class gui:
    ...
    def __init__(self,root):
        ...
        Gui.place(x=100,y=200)

        lbl_length = Label(Gui, text="Length of the video is: " + video_time, font=("Times new Roman", 20, "bold"),bg="white").grid(row=1, column=1)
        ...
        lbl_mostfrequent = Label(Gui, text="Most frequently occuring face is : " + most_frequent(names),
                                 font=("Times new Roman", 20, "bold"), bg="white").grid(row=2, column=1)
